...
The command \textit{TransitionPath\_{}Case1} (and \textit{\_{}Case2}) allows for easy calculation of the path of the price (vector) associated with the general equilibrium transition path of
a standard Bewley-Huggett-Aiyagari models.\footnote{General equilibrium incomplete market heterogeneous agent models with idiosyncratic, but no aggregate, shocks.}

As well as the standard inputs required for the general equilibrium command the other inputs needed are related to the (series of) parameter changes to be evaluated, including the final value function
and the initial stationary agents distribution.
...
\begin{enumerate}
 \item Many of the inputs are exactly the same as those used to compute the final general equilibrium with the $HeteroAgentStationaryEqm\_{}Case1$ command
   and the exact same notation applies (see Section \ref{sec:BHAmodel_GE}). \\
    (Namely \textcolor{RoyalBlue}{n\_{}d, n\_{}a, n\_{}z, d\_{}grid, a\_{}grid, z\_{}grid, pi\_{}z,} \\
...
\indent \textcolor{RoyalBlue}{  TransitionPath\_{}Case1(PricePath0, PricePathNames, ParamPath, ParamPathNames, T, V\_{}final, StationaryDist\_{}init, } \\
\indent \indent \textcolor{RoyalBlue}{   n\_{}d, n\_{}a, n\_{}z, pi\_{}z, d\_{}grid,a\_{}grid,z\_{}grid, )} \\
\indent \indent \textcolor{RoyalBlue}{   ReturnFn, FnsToEvaluate, GeneralEqmEqns, Parameters, DiscountFactorParamNames, } \\
\indent \indent \textcolor{RoyalBlue}{   ReturnFnParamNames, FnsToEvaluateParamNames, GeneralEqmEqnParamNames, PriceParamNames,} \\
